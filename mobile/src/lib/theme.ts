...
export const ui = StyleSheet.create({
  ...
  sheet: {
    ...
    paddingHorizontal: 20, paddingTop: 24, gap: 22,
  },
  eyebrow: { fontFamily: fonts.bodyBold, fontSize: 12, letterSpacing: 1.4, color: colors.blue },
  h1: { fontFamily: fonts.displayBold, fontSize: 30, lineHeight: 36, color: colors.ink },
  ...
  input: {
    ...
    paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, fontFamily: fonts.bodyMedium, color: colors.ink,
  },
  card: { backgroundColor: colors.bg, borderRadius: 22, padding: 18, gap: 6, ...shadow },
